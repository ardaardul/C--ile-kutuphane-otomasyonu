...
namespace Kutuphane.Forms.Forms
{
    public partial class Ogrenciler : Form
    {
        ...
        {
            ((Button)sender).BackColor = Color.FromArgb(0, 0, 0);
        ...
        private void btn_kitaplar_MouseHover(object sender, EventArgs e)
        {

        }

        private void btn_kitaplar_MouseLeave(object sender, EventArgs e)
        {

        }

        private void btn_ogrenciler_MouseHover(object sender, EventArgs e)
        {

        }

        private void btn_ogrenciler_MouseLeave(object sender, EventArgs e)
        {
        ...
        private void btn_islemler_MouseHover(object sender, EventArgs e)
        {

        }

        private void btn_islemler_MouseLeave(object sender, EventArgs e)
        {
        ...
        private void btn_grafik_MouseLeave(object sender, EventArgs e)
        {

        }

        private void dataGridViewOgrenciler_ColumnAdded(object sender, DataGridViewColumnEventArgs e)
        {
